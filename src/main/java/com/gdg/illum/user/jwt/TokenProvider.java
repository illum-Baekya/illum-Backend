...
public class TokenProvider {
    ...
    private static final String TOKEN_TYPE_CLAIM = "Illum/TokenType";
    ...
    public TokenProvider(@Value("${jwt.secret}") String jwtSecret, @Value("${jwt.access-token-validity-in-milliseconds}") long validityTime) {
